      ...
      {activeSection === "services" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="services" data={services} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
      ...
      {activeSection === "videos" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="videos" data={videos} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
      ...
      {activeSection === "places" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="places" data={places} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
      ...
      {activeSection === "plan" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="plan" data={plan} data={data} />
          </CardHeader>
      ...
      {activeSection === "about" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="about" data={about} data={data} />
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      {activeSection === "footer" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="footer" data={footer} data={data} />
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      {activeSection === "coupons" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="coupons" data={coupons} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
      ...
      {activeSection === "tropa" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="tropa_config" data={tropaConfig} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
      ...
      {activeSection === "seo" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="seo" data={seo} data={data} />
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      {activeSection === "instagram" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="instagram_config" data={instagramConfig} data={data} />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
      ...
      {activeSection === "languages" && (
        <Card className="bg-zinc-900 border-zinc-800 shadow-xl">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <SaveBtn section="languages" data={languages} data={data} />
          </CardHeader>
          <CardContent>

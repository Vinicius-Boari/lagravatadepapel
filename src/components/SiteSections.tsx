...
export const SiteSections = memo(function SiteSections({ content, onMenuClick }: { content: SiteContent; onMenuClick?: () => void }) {
  ...
  return (
    <>
      ...
      <a className="toronto-float" href="https://www.instagram.com/toronto.films/" target="_blank" rel="noopener noreferrer" aria-label="Toronto Produções">
        <img src="https://lovasiri.com.br/api/i/uk0ly6o0rm.png" alt="Toronto Produções" />
      </a>

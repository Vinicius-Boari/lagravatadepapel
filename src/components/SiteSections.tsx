...
export function SiteSections({ content, onMenuClick }: { content: SiteContent; onMenuClick?: () => void }) {
  ...
  return (
    <>
      ...
      <section className="tropa-section" id="tropa">
        <div className="tropa-container">
          <div className="tropa-content reveal">
            <span className="tropa-badge">🎖️ Serviço Exclusivo</span>
            <h2 className="tropa-title">🪖 Tropa da Gravata</h2>
            <p className="tropa-slogan">"Missão dada é gravata amarrada."</p>
            
            <div className="tropa-text">
              <p>
                A hora da gravata é uma das tradições mais queridas — e polêmicas 
                — dos casamentos brasileiros. Com raízes nos costumes trazidos pelos 
                imigrantes italianos e espanhóis no início do século XX, a brincadeira 
                tem um ritual bem definido: logo após a sobremesa, quando a festa já 
                está no embalo, padrinhos e amigos do noivo tomam a gravata do recém-casado, 
                saem de mesa em mesa e pedem contribuições dos convidados para a lua de mel. 
                Quem colabora leva um pedacinho da gravata como lembrança. Simples, 
                divertido — e, dependendo de quem está comandando, absolutamente inesquecível.
              </p>
              <br />
              <p>
                O problema? Na maioria dos casamentos, a brincadeira vira uma bagunça 
                sem graça, cheia de piadas prontas e uma bandeja de isopor passando de 
                mão em mão. A festa para. O noivo trava. Os convidados ficam sem saber 
                se riem ou fingem que estão no celular.
              </p>
              <br />
              <p>
                Foi aí que a Tropa da Gravata entrou em cena.
              </p>
              <br />
              <p>
                Inspirada no espírito inabalável do BOPE — o lendário Batalhão de 
                Operações Policiais Especiais eternizado no filme Tropa de Elite —, 
                nossa equipe invade o seu casamento com uma missão tática: transformar 
                a hora da gravata em um show à parte. Fardados, disciplinados e com 
                energia de operação de elite, os agentes da Tropa da Gravata dominam 
                o salão, abordam os convidados com humor afiado, criam momentos épicos 
                e garantem que todo mundo entre na brincadeira — inclusive aquele tio 
                que estava tentando escapar.
              </p>
              <br />
              <p>
                A operação é precisa. A diversão é garantida. E as fotos? Essas vão 
                ficar no álbum para sempre.
              </p>
            </div>

            <div className="tropa-cta-box">
              <span className="tropa-cta-label">Quer essa operação no seu casamento?</span>
              <a href="/questionarioevento" className="btn-tropa">
                CONTRATE AGORA
              </a>
              <a href="https://www.instagram.com/tropadagravata/" target="_blank" rel="noopener noreferrer" className="tropa-instagram">
                <Instagram className="w-5 h-5" />
                <span>@tropadagravata</span>
              </a>
            </div>
          </div>

          <div className="tropa-card-col reveal">
            <div className="tropa-card tilt-3d">
              <span className="tropa-icon">💀</span>
              <h3 className="tropa-card-title">BOPE da Gravata</h3>
              <p className="tropa-card-sub">Operação Lua de Mel — Missão Cumprida</p>
            </div>
          </div>
        </div>
      </section>

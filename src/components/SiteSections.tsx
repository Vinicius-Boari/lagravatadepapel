...
import { FullscreenMenu } from "./Site/FullscreenMenu";
import { Hero } from "./Site/Hero";
import { Ticker } from "./Site/Ticker";
import { Services } from "./Site/Services";
import { VideoGrid } from "./Site/VideoGrid";
import { ThePlan } from "./Site/ThePlan";
import { Places } from "./Site/Places";
import { About } from "./Site/About";
import { Tropa } from "./Site/Tropa";
import { Coupons } from "./Site/Coupons";
...
export const SiteSections = memo(function SiteSections({ content, onMenuClick }: { content: SiteContent; onMenuClick?: () => void }) {
  ...
  return (
    <>
      ...
      <Header isScrolled={isScrolled} onMenuClick={openMenu} />
      ...
      <a 
        className="toronto-float" 
        href="https://www.instagram.com/toronto.films/" 
        target="_blank" 
        rel="noopener noreferrer" 
        aria-label="Toronto Films Instagram"
      >
        <img 
